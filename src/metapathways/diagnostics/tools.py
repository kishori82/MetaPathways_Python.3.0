...
class Tools:
    ...
    def initializeTools(self):
        ...
        self.Tools = {
            "PREPROCESS_INPUT": {"exec": {"PREPROCESS_INPUT": None}},
            "ORF_PREDICTION": {"exec": {"ORF_PREDICTION": None}},
            "ORF_TO_AMINO": {"exec": {"ORF_TO_AMINO": None}},
            "FILTER_AMINOS": {"exec": {"PREPROCESS_INPUT": None}},
            "COMPUTE_REFSCORES": {
                "exec": {
                    "BLAST": {
                        "COMPUTE_REFSCORES": None,
                        "BLASTP_EXECUTABLE": None,
                        "FORMATDB_EXECUTABLE": None,
                    },
                    "LAST": {
                        "COMPUTE_REFSCORES": None,
                        "LAST_EXECUTABLE": None,
                        "LASTDB_EXECUTABLE": None,
                    },
                },
            },
            "FUNC_SEARCH": {
            ...
            "PARSE_FUNC_SEARCH": {"exec": {"PARSE_FUNC_SEARCH": None}},
            "SCAN_rRNA": {"exec": {"SCAN_rRNA": None, "BLASTN_EXECUTABLE": None}},
            "SCAN_tRNA": {"exec": {"SCAN_tRNA": None}},
            "ANNOTATE_ORFS": {"exec": {"ANNOTATE_ORFS": None}},
            "PATHOLOGIC_INPUT": {"exec": {"GENBANK_FILE": None}},
            "GENBANK_FILE": {"exec": {"GENBANK_FILE": None}},
            "CREATE_ANNOT_REPORTS": {"exec": {"CREATE_ANNOT_REPORTS": None}},
            "BUILD_PGDB": {"exec": {"PATHOLOGIC_EXECUTABLE": None}},
            "COMPUTE_RPKM": {"exec": {"COMPUTE_RPKM": None}},
        }
