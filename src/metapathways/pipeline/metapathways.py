...
try:
   ...
   from metapathways.pipeline.metapathways_pipeline import print_commands,  execute_tasks
   from metapathways.pipeline.MetaPathways_gather_run_stats import MetaPathways_gather_run_stats
   from metapathways.utils.metapathways_utils import fprintf, printf, eprintf, remove_existing_pgdb, exit_process, WorkflowLogger, generate_log_fp
