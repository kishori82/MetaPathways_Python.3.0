...
try:
    ...
    from metapathways.utils.metapathways_utils  import parse_command_line_parameters, fprintf, printf, eprintf
    from metapathways.utils.metapathways_utils  import strip_taxonomy, ShortenrRNAId, ShortenORFId, ShortenContigId, ContigID
    from metapathways.utils.sysutil import getstatusoutput
    from metapathways.utils.utils  import doesFileExist
