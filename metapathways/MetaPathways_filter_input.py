"""Filters the inputs, contigs,  to the pipeline"""
...
def main(argv, errorlogger=None, runstatslogger=None):
    ...
    outputStr = ""
    outputLines = []
    fastareader = fastreadrmod.FastaReader(opts.input_fasta)
    ...
    gutils.fprintf(logfile, "@INFO\tBEFORE\tAFTER\n")
    gutils.fprintf(
        logfile,
        "%s\n",
    ...
    gutils.fprintf(logfile, "@INFO\tLOW\tHIGH\tFREQUENCY\tCUMULATIVE_FREQUENCY\n")
    #    fprintf(logfile, "#   ---\t-----\t--------\t---------\t----------\n");
