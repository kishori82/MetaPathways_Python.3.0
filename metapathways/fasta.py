...
try:
    ...
    from sequences import SequenceRecordParser, SequenceRecordSerializer, SequenceRecord, SequenceFactory, Feature
except:
...
class FastaRecordSerializer(SequenceRecordSerializer):
    ...
    *description_format*. Possible substitutions include:
    ...
    def __init__(
        self, description_format="gi|%(gi_number)s|gb|%(accession)s|%(locus)s"
    ):
