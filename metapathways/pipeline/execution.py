...
try:
    ...
    from metapathways.utils.metapathways_utils import printf, eprintf
    from metapathways.utils.sysutil import getstatusoutput
    from metapathways.utils.pathwaytoolsutils import *

    import metapathways.scripts as python_scripts
...
def print_commands(commands, status_update_callback, logger):
